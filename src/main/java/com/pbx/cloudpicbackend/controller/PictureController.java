...
import com.pbx.cloudpicbackend.api.aliyunai.model.GetOutPaintingTaskResponse;
import com.pbx.cloudpicbackend.api.imagesearch.ImageSearchApiFacade;
import com.pbx.cloudpicbackend.api.imagesearch.model.ImageSearchResult;
...
import com.pbx.cloudpicbackend.manager.auth.SpaceUserAuthManager;
import com.pbx.cloudpicbackend.manager.auth.StpKit;
import com.pbx.cloudpicbackend.manager.auth.annotation.SaSpaceCheckPermission;
import com.pbx.cloudpicbackend.manager.auth.model.SpaceUserPermissionConstant;
import com.pbx.cloudpicbackend.model.enums.PictureReviewStatusEnum;
import com.pbx.cloudpicbackend.model.vo.CategoryVO;
import com.pbx.cloudpicbackend.model.vo.PictureTagCategory;
...
import com.pbx.cloudpicbackend.model.entity.Space;
...
public class PictureController {
    ...
    public BaseResponse<PictureVO> uploadAvatar(
            @RequestPart("file") MultipartFile multipartFile,
            PictureUploadRequest pictureUploadRequest,
            HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        PictureVO pictureVO = pictureService.uploadAvatar(multipartFile, pictureUploadRequest, loginUser);
        return ResultUtils.success(pictureVO);
    }
...
//        Picture picture = pictureService.getById(id);
        Picture picture = pictureService.getFullById(id);
    ...
    public BaseResponse<Page<Picture>> listPictureByPage(@RequestBody PictureQueryRequest pictureQueryRequest) {
        ...
        // 查询数据库
        Page<Picture> picturePage = pictureService.selectFullPage(new Page<>(current, size),
    ...
    public BaseResponse<PictureTagCategory> listPictureTagCategory() {
        ...
        List<CategoryVO> categoryList = categoryService.getVOByList(categoryService.list());
        List<TagVO> tagList = tagService.getPagesVoList(tagService.list());
    ...
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<String > uploadPictureByBatch(@RequestBody PictureUploadByBatchRequest pictureUploadByBatchRequest,
                                                      HttpServletRequest request) {
        ...
        CompletableFuture.runAsync(() -> {
            try {
                ...
                log.info("批量上传完成，成功上传{}张图片", uploadCount);
            } catch (Exception e) {
