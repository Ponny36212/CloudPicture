package com.pbx.cloudpicbackend.manager.auth;
...
import static com.pbx.cloudpicbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        // 获取请求参数
        if (ContentType.JSON.getValue().equals(contentType)) { // 处理 JSON 格式的请求体
            String body = ServletUtil.getBody(request);
            authRequest = JSONUtil.toBean(body, SpaceUserAuthContext.class);
        } else {    // 处理表单参数（GET 或 POST form-data/x-www-form-urlencoded）
